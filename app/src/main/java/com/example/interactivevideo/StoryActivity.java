...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.video1); // Ensure video1.mp4 is in res/raw folder
        ...
        optionA.setOnClickListener(v -> {
            Intent intent = new Intent(StoryActivity.this, Story1AActivity.class);
            startActivity(intent);
            finish(); // Close current activity
        });

        optionB.setOnClickListener(v -> {
            Intent intent = new Intent(StoryActivity.this, Story1BActivity.class);
            startActivity(intent);
            finish(); // Close current activity
        });
        ...
        Uri bgVideoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.bgdua); // Ensure bgdua.mp4 is in res/raw
