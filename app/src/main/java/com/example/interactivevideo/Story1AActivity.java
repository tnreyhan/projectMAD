...
public class Story1AActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story1_aactivity);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.video1a); // Ensure video1.mp4 is in res/raw folder
        ...
        optionA.setOnClickListener(v -> {
            Intent intent = new Intent(Story1AActivity.this, StoryActivity2.class);
        ...
        Uri bgVideoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.bgdua);
